...
public class CThostFtdcQryCombinationLegField : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(CThostFtdcQryCombinationLegField obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          CTPFutureApiPINVOKE.delete_CThostFtdcQryCombinationLegField(swigCPtr);
        }
  ...
  public int LegID {
    set {
      CTPFutureApiPINVOKE.CThostFtdcQryCombinationLegField_LegID_set(swigCPtr, value);
    } 
    get {
  ...
  public string LegInstrumentID {
    set {
      CTPFutureApiPINVOKE.CThostFtdcQryCombinationLegField_LegInstrumentID_set(swigCPtr, value);
    } 
    get {
      string ret = CTPFutureApiPINVOKE.CThostFtdcQryCombinationLegField_LegInstrumentID_get(swigCPtr);
      return ret;
    } 
  }

  public CThostFtdcQryCombinationLegField() : this(CTPFutureApiPINVOKE.new_CThostFtdcQryCombinationLegField(), true) {
  }
