...
public class CThostFtdcQryProductExchRateField : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(CThostFtdcQryProductExchRateField obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          CTPFutureApiPINVOKE.delete_CThostFtdcQryProductExchRateField(swigCPtr);
        }
  ...
  public string ExchangeID {
    set {
      CTPFutureApiPINVOKE.CThostFtdcQryProductExchRateField_ExchangeID_set(swigCPtr, value);
    } 
    get {
  ...
  public CThostFtdcQryProductExchRateField() : this(CTPFutureApiPINVOKE.new_CThostFtdcQryProductExchRateField(), true) {
  }
